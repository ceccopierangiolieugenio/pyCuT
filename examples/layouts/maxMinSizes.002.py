...
from CuT.CuTWidgets import CuApplication, CuMainWindow, CuWidget, CuHBoxLayout, CuVBoxLayout, CuFrame, CuPlainTextEdit
...
def main(screen):
	...
	log = CuPlainTextEdit(parent=window)
	log.setMaximumSize(10000,10)
	log.setMinimumSize(10,10)
